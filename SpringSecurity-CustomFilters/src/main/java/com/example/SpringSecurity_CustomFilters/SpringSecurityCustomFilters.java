package com.example.SpringSecurity_CustomFilters;

import com.example.SpringSecurity_CustomFilters.constants.EncryptAlgo;
import com.example.SpringSecurity_CustomFilters.model.BusinessUser;
import com.example.SpringSecurity_CustomFilters.model.BusinessUserAuthorities;
...
public class SpringSecurityCustomFilters implements CommandLineRunner {

	@Autowired
	private BusinessUserRepository userRepository;

	public static void main(String[] args) {
		SpringApplication.run(SpringSecurityCustomFilters.class, args);
	}
