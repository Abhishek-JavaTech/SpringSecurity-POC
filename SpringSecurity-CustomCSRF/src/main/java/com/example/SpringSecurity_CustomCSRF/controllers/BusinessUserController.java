...
import static com.example.SpringSecurity_CustomCSRF.constants.EncryptAlgo.SCRYPT;
...
public class BusinessUserController {
    ...
    public ResponseEntity getAllUser(Authentication authentication){
        try{
//            uncomment below line only when there is authentication set for /users API with HttpMethod GET
